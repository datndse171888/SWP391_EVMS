...
import { getAllUsers, createUser, getCertificates, getTechnicianInfo, getTechnicianCertificates, updateUser, updateUserStatus } from '../controllers/userController.js';
